<p>This list is small, incomplete. Because the real one (in my head) is too long. I'll continue it in my free time.</p>
<h2>Literature</h2>
<ul>
	<li>
...
<ul>
	...
	<li>
		...
		<ul>
			...
			<li>Robert Rozhdestvensky - Moments</li>
			<li>
				Toto Cutugno
				<ul>
					<li>L'italiano</li>
...
<ul>
	<li>
		...
		<ul>
			...
			<li><a href="https://upload.wikimedia.org/wikipedia/commons/6/6b/Arthur_Schopenhauer_Portrait_by_Ludwig_Sigismund_Ruhl_1815.jpeg">Ludwig Sigismund Ruhl - Arthur Schopenhauer</a></li>
